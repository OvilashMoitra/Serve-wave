                    ...
                    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
                        <div className="max-w-2xl text-center mx-auto">
                            ...
                            <div className="mt-5 max-w-3xl">
                                <p className="text-lg text-gray-600 dark:text-gray-400">Serve wave is not just a company; It is a mindset, a commitment to excellence, and a passion for staying ahead of the curve. Together, we willl lead the rest, setting new standards in cybersecurity. So, gear up and get ready to embark on an exciting adventure with Serve wave – where your skills are honed, your talents are recognized, and your potential knows no limits.</p>
                            </div>
